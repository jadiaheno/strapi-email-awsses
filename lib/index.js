...
module.exports = {
  ...
  auth: {
    awsses_default_from: {
      label: 'Amazon Web Services SES default form',
      type: 'text'
    },
    ...
    return {
      send: (options, cb) => {
        return new Promise((resolve, reject) => {
          ...
          options.from = options.from || config.awsses_default_from;
          options.replyTo = options.replyTo || config.awsses_default_replyto;
